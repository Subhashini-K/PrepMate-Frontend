...
const RoleInfoHeader = ({
  ...
  return <div className="bg-white relative">
    <div className="container mx-auto px-10 md:px-10 flex justify-between">
      ...
      <div className='w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden aboslute top-0 right-0'>
