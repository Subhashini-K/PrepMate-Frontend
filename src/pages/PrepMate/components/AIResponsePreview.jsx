...
const AIResponsePreview = ({ content }) => {
  ...
  if (inline) {
    return (
      <code className="bg-gray-100 text-pink-600 px-1 py-0.5 rounded text-[13px] font-mono">
        {children}
      </code>
    );
  }

  // Render block only if multi-line or long
  ...
  // Fallback for short one-liners — make it look like inline code
  return (
    <code className="bg-gray-100 text-pink-600 px-1 py-0.5 rounded text-[13px] font-mono">
      {codeString}
    </code>
